...
//1.创建钱包集合
func JZ_NewWallets(nodeID string) (*JZ_Wallets, error) {
...
//2.创建新钱包
func (wallets *JZ_Wallets) JZ_CreateWallet(nodeID string)  {
	...
	//保存到本地
	wallets.JZ_SaveWallets(nodeID)
}

//3.保存钱包集信息到文件
func (wallets *JZ_Wallets) JZ_SaveWallets(nodeID string)  {
